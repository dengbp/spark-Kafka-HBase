...
public interface Constants {
	...
	/**
	 * Description 路由配置（数据落地路由(01:hbase,02:mysql 多个用逗号隔开)）
	 * @Author dengbp
	 * @Date 11:39 2020-03-12
	 **/
	String DATA_WRITE_ROUTING = "data.write.routing";
	String DATA_WRITE_ROUTING_SPLIT = ",";
	...
	/** 临时写死配置表主键 */
	String TB_UHOME_ACCT_ITEM_OWES_PRIMARY_KEY = "acct_item_id";
	String TB_UHOME_ACCT_ITEM_PRIMARY_KEY = "acct_item_id";
